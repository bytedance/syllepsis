...
const Todo = React.forwardRef((props: ILazyProps, ref) => {
    ...
    return <div className={cs('todo-quadrant', { 'column': isColumn })}>
        ...
        <Quadrant data={data[QUADRANT_TYPE.FIRST]} type={QUADRANT_TYPE.FIRST} placeholder={'important & urgent'} onChange={changeData}/>
        <Quadrant data={data[QUADRANT_TYPE.SECOND]} type={QUADRANT_TYPE.SECOND} placeholder={'important & not urgent'} onChange={changeData}/>
        <Quadrant data={data[QUADRANT_TYPE.THIRD]} type={QUADRANT_TYPE.THIRD} placeholder={'not important & urgent'} onChange={changeData}/>
        <Quadrant data={data[QUADRANT_TYPE.FORTH]} type={QUADRANT_TYPE.FORTH} placeholder={'not import & not urgent'} onChange={changeData}/>
    </div>
});
