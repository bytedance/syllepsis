...
class AlignController extends SylController {
  ...
  public command = {
    setStyle: (editor: SylApi) => {
      setAlign(editor.view, this.value);
      editor.focus();
    }
  };

  public disable = (editor: SylApi) => !(editor.view.state.selection instanceof AllSelection) && !checkParentSupportAttr(editor.view, 'align');
